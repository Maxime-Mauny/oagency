 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'ki}dk=O1h<@x+K9|/(V3K}/KA7,Wfb8ZWkBd5v-a-F-a-6YAkU+NNsS%-4rW!Uqa');
define('SECURE_AUTH_KEY',  '|;js&k}-!!:qQ Fl^FqxE8,r{=DFA-QQ:Jh@~:K-TW++r{g>M-3U6~c>OR?,@REK');
define('LOGGED_IN_KEY',    '0+TSG>YP!F9&83:L/0L#Tu)>>2mquL(!6_OV42g*![E}pp;$i@$G4osLO``s6Mqt');
define('NONCE_KEY',        'pG$yrKOk_8/xFZ]~OXFNMiQw1,-{b%p$PfE[c]6ULMHInG:tKS;0tTI,FI+XyYCN');
define('AUTH_SALT',        'V;{w!2rJP[/*g`a&H<Q40+vR 9&d+_yOdf0,+T 4uSzUHCr~`.;-!urlMbD{[`f?');
define('SECURE_AUTH_SALT', '?IvJ6;VJfSRaX~}tz-Lk!~N8@K9Z}w5XrluoBg@W9YbUo,]I?)FQ%bp<9S;<(PE`');
define('LOGGED_IN_SALT',   'GX<XP$ZxS+I0](m2!yH8A_z_}4^KkNd3boN2H{sfM|YT6ceJ<;O;WpW#ZfdZO^;l');
define('NONCE_SALT',       ';|S+7+rM>Of7hsp* JR?-0f^@vk@2{m`@4kS.|)Ffug^+.E2RVm)9}-nP-l9fE|+');
/**#@-*/
...
define( 'WP_CONTENT_URL', 'http://localhost/SPE-WordPress/WP-Eval-oAgency-Maxime-Mauny/content' );
